...
Feature: SU_TC19_Certificate_download

  @SU_TC19_Certificate_download
  Scenario: SU_TC19_Certificate_download
  ...
  And User clicks on the Register Now button
   ...
   Then User should be navigated to the Please choose your profession page
    ...
    When User Selects the Course as "Healthcare Provider CPR and First Aid Combo"
    And User enters the quantity as "2"
    And User tap on Add to Card button 
