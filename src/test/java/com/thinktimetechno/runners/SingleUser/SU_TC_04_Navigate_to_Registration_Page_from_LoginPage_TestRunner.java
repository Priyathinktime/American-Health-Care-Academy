...
@CucumberOptions(features = "src/test/resources/features", glue = {
		"com.thinktimetechno.projects.website.stepdefinitions.SingleUser", "com.thinktimetechno.hooks" }, plugin = {
				...
				tags = "@SU_TC04_Navigate_to_Registration_Page_from_Login_Page")

public class SU_TC_04_Navigate_to_Registration_Page_from_LoginPage_TestRunner extends AbstractTestNGCucumberTests {
	@Override
