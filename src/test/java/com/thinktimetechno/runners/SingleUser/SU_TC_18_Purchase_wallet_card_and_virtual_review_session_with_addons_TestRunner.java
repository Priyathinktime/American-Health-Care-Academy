...
@CucumberOptions(features = "src/test/resources/features", glue = {
		"com.thinktimetechno.projects.website.stepdefinitions.SingleUser", "com.thinktimetechno.hooks" }, plugin = {
				...
				tags = "@SU_TC_18_Purchase_walletcard_and_virtual_review_session_add-ons")

public class SU_TC_18_Purchase_wallet_card_and_virtual_review_session_with_addons_TestRunner extends AbstractTestNGCucumberTests {
	@Override
