...
@CucumberOptions(features = "src/test/resources/features/GroupUser", glue = {
		"com.thinktimetechno.projects.website.stepdefinitions.CorporateUser", "com.thinktimetechno.hooks" }, plugin = {
				...
				"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:" }, monochrome = true, tags = "@C_TC_02_Register_with_leaving_one_mandatory_field_blank")

public class C_TC_02_Register_leaving_one_mandatory_field_blank_TestRunner extends AbstractTestNGCucumberTests {
	@Override
