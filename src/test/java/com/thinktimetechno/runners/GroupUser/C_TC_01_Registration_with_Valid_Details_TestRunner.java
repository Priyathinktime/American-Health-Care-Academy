...
@CucumberOptions(features = "src/test/resources/features/GroupUser", glue = {
		"com.thinktimetechno.projects.website.stepdefinitions.CorporateUser", "com.thinktimetechno.hooks" }, plugin = {
				...
				"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:" }, monochrome = true, tags = "@C_TC_01_Corporate_Registration_with_Valid_Details")

public class C_TC_01_Registration_with_Valid_Details_TestRunner extends AbstractTestNGCucumberTests {
	@Override
