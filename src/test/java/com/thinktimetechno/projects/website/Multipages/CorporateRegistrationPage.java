...
public class CorporateRegistrationPage {
	...
	public void Group_Registration_page_validation(){
		...
		Assert.assertEquals(PageTitle, "Dashboard | Groupadmin - American Health Care Academy");
	}
	public void error_validation(String error) {
	
		String error_message= WebUI.waitForElementVisible(By.xpath("//form[@id='form_groupdiscount']/descendant::div[@id='error_message_dv2']")).getText();
	...
	public void click_register() throws InterruptedException {
		...
		public void enter_registration_details(String firstName,String lastname, String companyname, String phonenumber, String emailaddress,String createpassword, String confirmpassword  ) {
		...
		public void enter_existing_registration_detail(String firstName,String lastname,String companyname,String phonenumber, String emailaddress,String createpassword, String confirmpassword  ) {
