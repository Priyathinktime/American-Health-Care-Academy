...
public void success_message_validation( String success) {
	 ...
	 WebElement sucessElement = WebUI.waitForElementVisible(By.xpath("//form[@id='Resetform']//div[@class='redText']"));
...
public void error_message_validation( String error) {
	 WebElement errorElement = WebUI.waitForElementVisible(By.xpath("//div[@id='register_box']//p[contains(text(),'Your email / password combination is invalid.')]"));
