...
public class RegistrationPage {
	...
	public void enter_payment_detail(String card, String cardNumber, String expirationMonth, String ExpirationYear, String CVVCode,
            String FullNameonCard, String BillingAddress, String BillingCity, String BillingState, String BillingZip) throws InterruptedException {
...
WebElement monthDropdown = WebUI.waitForElementVisible(By.xpath("(//select[@name='payment[cc_exp_month]'])[1]"));
...
// No alert - continue silently
	...
	public void enter_shipping_detail(String firstname, String lastname, String Company, String Address,
...
//                ((JavascriptExecutor) DriverManager.getDriver()).executeScript("arguments[0].blur();", addressInput);
	...
	public void enter_registration_detail_with_code(String firstName, String lastname, String phonenumber, String emailaddress,
			String username, String password, String confirmpassword, String Code) throws InterruptedException {
		String dateTime = new java.text.SimpleDateFormat("yyyyMMddHHmmss").format(new java.util.Date());
		String emailAddress = emailaddress.replace("john.doe", "john.doe" + dateTime);
